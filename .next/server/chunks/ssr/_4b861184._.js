...
function ProfilePage() {
    ...
    const handleChange = (e)=>{
        ...
        if (name === 'photo' && files?.[0]) {
            ...
            if (!validTypes.includes(file.type)) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Format file harus JPG atau PNG');
                return;
            }
            if (file.size > maxSizeMB * 1024 * 1024) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Ukuran file maksimal 1MB');
                return;
            }
            setForm((prev)=>({
                    ...prev,
    ...
    const handleLogout = async ()=>{
        ...
        if (res.ok) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Gagal logout');
        }
    };
...
//# sourceMappingURL=_4b861184._.js.map