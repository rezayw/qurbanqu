...
"[project]/utils/encrypt.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function comparePassword(input, hashed) {
    return __TURBOPACK__imported__module__$5b$externals$5d2f$bcrypt__$5b$external$5d$__$28$bcrypt$2c$__cjs$29$__["default"].compare(input, hashed);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$encrypt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/encrypt.ts [app-route] (ecmascript)");
;
;
;
;
async function POST(req) {
    ...
    const exist = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$user$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["User"].findOne({
        username
    });
    if (exist) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'User sudah ada'
    }, {
        status: 400
    });
    const hashed = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$encrypt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashPassword"])(password);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__70af313c._.js.map